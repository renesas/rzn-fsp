...
[FSP v3.1.0](https://github.com/renesas/rzn-fsp/releases/tag/v3.1.0)
...
- FSP versions of 1.0.0 requires a minimum e² studio version of 2022-07.
...
- FSP versions of 2.1.0 requires a minimum e² studio version of 2024-10.
- FSP versions of 2.2.0 requires a minimum e² studio version of 2025-01.
...
1.	Download the FSP with e² studio Installer from the Assets section of the [current release](https://github.com/renesas/rzn-fsp/releases/tag/v3.1.0).
...
2. Download the FSP Smart Configurator Installer from the Assets section of the [current release](https://github.com/renesas/rzn-fsp/releases/tag/v3.1.0).
