...
void r_rsip_p32u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0xfbb3a9e5U),
                   bswap_32big(0x3c1a7dc2U),
                   bswap_32big(0x5d27109fU),
                   bswap_32big(0x56611793U));
    ...
    RD1_ADDR(REG_1420H, &OutData_Text[iLoop - 1]);
    r_rsip_func206();
    r_rsip_func101(bswap_32big(0xfb750e33U),
                   bswap_32big(0xdfa99b20U),
                   bswap_32big(0xd0e2ccb0U),
                   bswap_32big(0xdef815ffU));
}
