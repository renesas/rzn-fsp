...
void r_rsip_p36u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x88875649U),
                   bswap_32big(0xb7409ad5U),
                   bswap_32big(0xde9cffa0U),
                   bswap_32big(0x852f9295U));
    ...
    RD1_ADDR(REG_1420H, &OutData_Text[iLoop - 1]);
    r_rsip_func206();
    r_rsip_func101(bswap_32big(0xc001010eU),
                   bswap_32big(0xdc68578bU),
                   bswap_32big(0x2e40061aU),
                   bswap_32big(0xdc41e2eeU));
}
